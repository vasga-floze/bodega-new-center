...
$("#finalizar").click(function(){
    console.log("Entro al finalizar");
   ...
   /**
    **SI BODEGA ORIGEN ES IGUAL A BODEGADESTINO 
    */
   ...
   let bodegaOrigenDosLetras=bodegaOrigen.substring(0,2)
   let bodegaDestinoDosLetras=bodegaDestino.substring(0,2)

   
   if (bodegaOrigenDosLetras===bodegaDestinoDosLetras) {
    ...
    $.ajax({
        ...
        url:"controladorFinalizarDespacho.php",
        type:'POST',
        data:objetoDatos,
        success:function(response){
            console.log(response);
