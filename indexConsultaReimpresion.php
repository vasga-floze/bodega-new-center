...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Consulta Reimpresion</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-4">
                            ...
                            <input type="text" class="form-control" id="fechaInicio" aria-describedby="emailHelp">
                        ...
                        <div class="col-xl-4 col-md-4">
                            ...
                            <input type="text" class="form-control" id="fechaFinal" aria-describedby="emailHelp">
                        ...
                        <div class="col-xl-4 col-md-4">
                            ...
                            <input type="email" class="form-control" id="codigoArticulo" aria-describedby="emailHelp">
    ...
    <script src="js/scriptsConsultaReimpresion.js"></script>
