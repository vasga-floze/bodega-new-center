...
<table class="tabla" border="0">
	...
	<tr>
		...
		<td>EMPAQUE<br>
			<SELECT name="empaq" class="text" style="padding-top: 1%; padding-bottom: 1%; width: 68%;">
				<option value="0">(SELECCIONAR)</option>
				<option value="CAJA">CAJA</option>
				<option value="BOLSA">BOLSA</option>
			</SELECT>
			<?php
			$empaquesel=$_POST['empaq'];
			?>
			<br><br>
		</td>
	</tr>
...
while($nums!=0)
{
	...
	if ($empaq=="0") {
		echo "<script>alert('Debe seleccionar el tipo de empaque')</script>";
	}
	else
		{
		echo "<script>location.replace('ingreso.php')</script>";
