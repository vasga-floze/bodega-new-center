                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Agregar Tipo Empaque</h5>
                                            ...
                                            <form method="POST" id="formulario">
                                                <div class="mb-3">
                                                    <label class="mb-3" for="exampleInputEmail1"
                                                        class="form-label">Agregar Tipo Empaque</label>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" id="enviarTransaccion"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php 
                                    $query =$dbBodega->prepare("SELECT idTipoTransaccion,TipoTransaccion FROM dbo.TIPOTRANSACCION");
                                    $query->execute();
                                    $data = $query->fetchAll();
                                    ...
                                    foreach($data as $item){
                                        ...
                                        echo "<td>".$item["TipoTransaccion"]."</td>";
                                    }
                                    ?>
