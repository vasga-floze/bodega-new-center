...
<?php
$qe=$conexion1->query("select bodega from consny.bodega where bodega like 'SM%' and nombre not like '%(N)%' or bodega='CA00'")or die($conexion1->error());
...
")or die($conexion2-error());
	...
	}else
	{
		...
		echo "
		<tr>
		<td colspan='6'><a href='expor_tras_art.php?d=$desde&&h=$hasta&&clasi=$clasificacion&&bodega=$bodega'>EXPORTAR A EXCEL</a>
