...
<form method="POST" style="margin-bottom: -5%;">
	DESDE: <input type="date" name="desde" class="text" style="padding: 0.5%; width: 30%;">
	HASTA: <input type="date" name="hasta" class="text" style="padding: 0.5%; width: 30%;">
...
if($_POST)
{
	...
	{
		echo "<a href='export_reporte_produccion_mensual.php?desde=$desde&&hasta=$hasta' target='_blank;'>Exportar a Excel</a>";
