...
<head>
	...
	<script>
		...
		function cerrar()
		{
			location.replace('ingreso.php');
		}
	</script>
</head>
<body>
<
<div class="detalle" style="scrollbar-color:gray CadetBlue;	scrollbar-width:thin;">
...
<form method="POST">
	<input type="text" name="b" id="b" placeholder="CODIGO O NOMBRE" class="text" style="width: 30%; float: center; margin-left: 1%;">
...
")or die($conexion1->error());
 ...
 }else
 {
 	...
 	while($f=$c->FETCH(PDO::FETCH_ASSOC))
 	{
 		...
 		$des=$f['DESCRIPCION'];
 		echo "<tr>
 		<td><a href='ingreso.php?i=5&&art=$art' class='aref'>$art</a></td>
 		<td><a href='ingreso.php?i=5&&art=$art' class='aref'>$des</a></td>
 	</tr>";
