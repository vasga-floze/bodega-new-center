...
$queryImprimirBarras=$dbBodega->prepare("SELECT REGISTRO.CodigoBarra,
                                         REGISTRO.Articulo, REGISTRO.Descripcion,
                                         REGISTRO.FechaCreacion, REGISTRO.Libras,
                                         UBICACION.Ubicacion
                                         FROM REGISTRO INNER JOIN
                                         UBICACION 
                                         ON REGISTRO.IdUbicacion=UBICACION.IdUbicacion
                                         WHERE articulo='$articulo' AND
                                         documento_inv='$contenedor' AND
                                         fechacreacion='$fecha'");
...
$query =$dbBodega->prepare(
    "SELECT REGISTRO.CodigoBarra, REGISTRO.Articulo, REGISTRO.Descripcion, 
    REGISTRO.Observaciones,UBICACION.Ubicacion Ubicacion
    FROM REGISTRO INNER JOIN
