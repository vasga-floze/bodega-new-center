...
$query =$dbBodega->prepare("DECLARE @DOCUMENTO_INV NVARCHAR(25)='TRA-0000034198'
...
$pdf->SetY(40);
$pdf->SetFont('Arial','',10);
$pdf->Cell(190,7,'Documento:1651541',0,1,'R');
...
WHERE       transaccion.Documento_Inv='TRA-0000034198' and (TRANSACCION.IdTipoTransaccion = 3)
...
foreach ($data as $key => $resumen) {
    ...
    $pdf->Cell(80,6,$resumen['Descripcion'],1,0,'C');
    $pdf->Cell(30,6,$resumen['Cantidad'],1,0,'C');
    $pdf->Cell(30,6,$resumen['Libras'],1,1,'C');
    # code...
}
