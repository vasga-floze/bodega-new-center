                            ...
                            <form>
                                ...
                                <div class="row justify-content-start form-floating mb-3">
                                    ...
                                    <div class="col-6 ">
                                        ...
                                        <input id="fechaProduccion" value="<?php echo(isset($fechaActual))?$fechaActual:'';?>" class="form-control mb-3" id="inputEmail" type="date" placeholder="" disabled />
                                ...
                                <div class="row justify-content-start form-floating mb-3">
                                    ...
                                    <div class="col-6 ">
                                        ...
                                        <input id="usuario" value="<?php echo(isset($usuario))?$usuario:'';?> "
                                            class="form-control mb-3" id="inputEmail" type="text" placeholder="" disabled />
                    ...
                    <div class="row">
                        <div class="col-6 row justify-content-start form-floating ">
                            <div class="d-grid gap-2 col-12">
                                <button type="button" id="ropa" name="ropa" class=" btn btn-secondary btn-lg">Ropa</button>
