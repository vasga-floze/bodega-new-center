...
while($nums!=0)
{
	...
	digitado,
	fecha_documento,
	barra,session,codigo,estado,paquete,usuario,bodega,tipo,observacion,fecha_ingreso,bodega_produccion) values('$btn',
	'$numf',
	'$lbs',
	'$unid',
	'$empacado',
	...
	'$digitado',
	'$fecha',
	'$barra','$session','','0','$paq','$usui','$bodegaart','P','$obs',getdate(),'$bodegaart')")or die($conexion2->error);
	echo "<script>location.replace('ingreso.php')</script>";
